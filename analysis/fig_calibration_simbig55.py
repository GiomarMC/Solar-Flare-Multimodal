...
Copia paralela de graficos/fig_calibration_en.py para el camera-ready de SIMBig (SIMBig55/).
...
No modifica graficos/fig_calibration_en.py ni RedaccionSIMBig/images/, que sirven a la versión
...
def main():
    ...
    plt.close(fig)
    print("Generated: SIMBig55/images/fig6_calibracion_48h.pdf  "
