"""
Ablación de arquitectura de la BiGRU standalone — 48 h (parametriza hidden y num_layers).
...
Uso:
    python studies/01_recurrent_architecture/train_gru_ablation.py --fold 3 --hidden 64 --num_layers 1
    python studies/01_recurrent_architecture/train_gru_ablation.py --fold 3 --hidden 128 --num_layers 2 --smoke 5
"""
import os
import sys
import argparse
