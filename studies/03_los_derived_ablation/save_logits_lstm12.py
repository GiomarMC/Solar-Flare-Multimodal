...
Usage:
    python scripts/save_logits_lstm12.py
    python scripts/save_logits_lstm12.py --horizon 24
    python scripts/save_logits_lstm12.py --horizon 48 --fold 3
"""
...
from scripts.train_lstm12_standalone import (
...
def run_fold(base_dir: str, horizon: int, fold: int, device: torch.device):
    ...
    cfg_path  = f"configs/lstm12_cv_{horizon}h_k{fold}.yaml"
...
def main():
    ...
    sample_cfg = "configs/lstm12_cv_24h_k0.yaml"
